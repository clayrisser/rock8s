...
EOT
  ...
  node_sizes = {
    "small"  = { cores = 1, memory = 2048, disk_gb = 20 }
    "medium" = { cores = 2, memory = 4096, disk_gb = 40 }
    "large"  = { cores = 4, memory = 8192, disk_gb = 80 }
  ...
  node_private_ipv4s = {
    for idx, vm in proxmox_virtual_environment_vm.nodes :
