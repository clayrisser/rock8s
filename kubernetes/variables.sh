...
export TF_VAR_k8s_control_plane_disk_size="$VM_K8S_CONTROL_PLANE_DISK_SIZE"
export TF_VAR_k8s_control_plane_memory="$VM_K8S_CONTROL_PLANE_MEMORY"
export TF_VAR_k8s_control_plane_node_count="$VM_K8S_CONTROL_PLANE_NODE_COUNT"
export TF_VAR_k8s_control_plane_vcpus="$VM_K8S_CONTROL_PLANE_VCPUS"
export TF_VAR_k8s_worker_disk_size="$VM_K8S_WORKER_DISK_SIZE"
export TF_VAR_k8s_worker_memory="$VM_K8S_WORKER_MEMORY"
export TF_VAR_k8s_worker_node_count="$VM_K8S_WORKER_NODE_COUNT"
export TF_VAR_k8s_worker_vcpus="$VM_K8S_WORKER_VCPUS"
...
export TF_VAR_max_vcpus="$VM_MAX_VCPUS"
export TF_VAR_os_disk_storage="$VM_OS_DISK_STORAGE"
...
export TF_VAR_sockets="$VM_SOCKETS"
export TF_VAR_ssh_public_keys_b64="$SSH_PUBLIC_KEYS_B64"
export TF_VAR_user="$VM_USER"
